...
export const ViewExperiences = ({ article, titles }) => {
  const { StackRow, StackRowLeft, PreBlock } = genericStyles;
  ...
  return (
    <>
      ...
      <Box>
        <StackRowLeft>
          <Typography variant="body1">{article.employmentType}</Typography>

          <Typography variant="body1">{article.contractType}</Typography>

          {article.location.length > 0 && (
            <Typography variant="body1">{article.location}</Typography>
          )}
          ...
          <StackRow>
            ...
            {article.currentlyWork ? (
              ...
              <>
                <Typography variant="body1">-</Typography>
                <Typography variant="body1">{article.endDate}</Typography>
              </>
            )}
          </StackRow>
        </StackRowLeft>
